...
import remarkIgnore, {
  ignoreStart,
  ignoreEnd
} from 'pkgverse/remark-tight-comments/src/index';
import defaultIgnoreStart from 'pkgverse/remark-tight-comments/src/start';
import defaultIgnoreEnd from 'pkgverse/remark-tight-comments/src/end';
import {
  getFixtureString,
  getFixtureVFile
...
describe('::default', () => {
  ...
  it('ignores the next node via remark-tight-comments', async () => {
    expect.hasAssertions();
  ...
  it('ignores a range of nodes via remark-tight-comments-start/end', async () => {
    expect.hasAssertions();
  ...
  it('does not malfunction on orphan remark-tight-comments-end', async () => {
    expect.hasAssertions();
  ...
  it('does not malfunction on redundant remark-tight-comments', async () => {
    expect.hasAssertions();
